                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('admin.leaders.edit', $leader->id) }}" class="btn btn-success me-2">
                                                                    <i class="mdi mdi-pencil"></i>
                                                                </a>
                                                                <form action="{{ route('admin.leaders.destroy', $leader->id) }}" method="POST" onsubmit="return confirm('Silmek istediğinize emin misiniz?');">
                                                                    @csrf
                                                                    @method('DELETE')
...
@push('js')
    ...
    <script>
        function deleteItem(id) {
            ...
            let url = "{{ route('admin.leaders.destroy', ':id') }}".replace(':id', id);
