        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.blog_types.index') }}">{{ __('Blog Türləri') }}</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.blog_types.update', $blogType->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <a href="{{ route('admin.blog_types.index') }}" class="btn btn-secondary">{{ __('Ləğv et') }}</a>
                                    </div>
                                </div>
                            </form>
                        </div>
