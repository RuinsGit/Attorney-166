            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <a href="{{ route('admin.blog_types.create') }}" class="btn btn-primary">{{ __('Yeni Blog Türü') }}</a>
                            </div>
                                ...
                                <table class="table table-bordered mb-0" id="blogTypesTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.blog_types.edit', $blogType->id) }}" class="btn btn-primary btn-sm">{{ __('Redaktə') }}</a>
                                                <form action="{{ route('admin.blog_types.destroy', $blogType->id) }}" method="POST" class="d-inline-block">
                                                    @csrf
                                                    @method('DELETE')
