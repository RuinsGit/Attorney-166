...
class SocialMediaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.social.index')->with('success', 'Sosial media uğurla əlavə edildi');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.social.index')->with('success', 'Sosial media uğurla yeniləndi');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.social.index')->with('success', 'Sosial media uğurla silindi');
    }
