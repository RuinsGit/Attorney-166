...
class BlogTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.blog_types.index')->with('success', __('Blog türü başarıyla oluşturuldu.'));
    }
    ...
    public function update(Request $request, BlogType $blogType)
    {
        ...
        return redirect()->route('admin.blog_types.index')->with('success', __('Blog türü başarıyla güncellendi.'));
    }

    public function destroy(BlogType $blogType)
    {
        $blogType->delete();
        return redirect()->route('admin.blog_types.index')->with('success', __('Blog türü başarıyla silindi.'));
    }
} 